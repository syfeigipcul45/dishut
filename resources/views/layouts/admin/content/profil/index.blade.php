                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <a href="{{route('profil.create')}}" class="btn btn-primary waves-effect" role="button" aria-haspopup="true" aria-expanded="false">
                                    Tambah Data
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table id="tabel_profil" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Sub Menu</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-default btn-xs waves-effect" data-placement="top" title="Edit" id="btnEdit" name="btnEdit" href="{{route('profil.edit', $item->id)}}"><i class="material-icons">edit</i></a>
                                            <!-- @csrf -->
                                            <!-- @method('DELETE') -->
