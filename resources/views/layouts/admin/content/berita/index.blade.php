                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <a href="{{route('berita.create')}}" class="btn btn-primary waves-effect" role="button" aria-haspopup="true" aria-expanded="false">
                                    Tambah Data
                                </a>
                            </li>
                        </ul>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-default btn-xs waves-effect" data-placement="top" title="Edit" id="btnEdit" name="btnEdit" href="{{route('berita.edit', $item->id)}}"><i class="material-icons">edit</i></a>
                                            <!-- @csrf -->
                                            <!-- @method('DELETE') -->
