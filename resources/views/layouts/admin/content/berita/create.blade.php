                        ...
                        <form action="{{route('berita.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="judul_berita" id="judul_berita" placeholder="Judul Berita" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea name="isi_berita" id="tinymce"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br><img class="b p-xs" style="max-width: 350px; max-height: 150px;" id="output">
                                    </div>
                                </div>
                            </div>
