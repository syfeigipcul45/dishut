            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-blue">
                        ...
                        <h4><a href="https://kaltimprov.go.id/" target="__blank">Pemerintah Prov. Kalimantan Timur</a></h4>
                        <p>Website resmi Pemerintah Provinsi Kalimantan Timur
                            "Berani untuk Kaltim Berdaulat"</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box iconbox-orange ">
                        ...
                        <h4><a href="https://www.menlhk.go.id/" target="__blank">Kementerian Lingkungan Hidup dan Kehutanan</a></h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-pink">
                        ...
                        <h4><a href="http://kph.menlhk.go.id/sinpasdok/" target="__blank">KPH Indonesia</a></h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-yellow">
                        ...
                        <h4><a href="https://goo.gl/6cqVTS" target="__blank">Form Permohonan Data</a></h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box iconbox-red">
                        ...
                        <h4><a href="https://sipesanantar.kaltimprov.go.id/" target="__blank">SI-PESAN ANTAR</a></h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box iconbox-teal">
                        ...
                        <h4><a href="https://forms.gle/XUHwNhd9a6oWUq7SA" target="__blank">Form Pengaduan Masyarakat</a></h4>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-10 " data-aos="fade-up">
                    <div class="icon-box text-center">
                        <iframe width="400" height="300" src="https://www.youtube.com/embed/sSa6fx9TwyQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-4 col-md-10 " data-aos="fade-up">
                    <div class="icon-box text-center">
                        <iframe width="400" height="300" src="https://www.youtube.com/embed/wGxZNj7wVYM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-4 col-md-10 " data-aos="fade-up">
                    <div class="icon-box text-center">
                        <iframe width="400" height="300" src="https://www.youtube.com/embed/23SzB7jMB44" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
